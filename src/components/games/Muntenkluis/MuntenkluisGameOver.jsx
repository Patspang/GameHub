// Win screen for Muntenkluis — always a win (no lose condition)
// Shows full vault, coins, score, and optional high score badge
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[60vh] px-4 py-8">
      ...
      <h2 className="font-display text-4xl font-bold text-text-primary text-center mb-4">
        {DUTCH_TEXT.muntenkluis.feedback.allComplete}
      </h2>

      <p className="font-body text-xl text-text-secondary text-center mb-2">
        {DUTCH_TEXT.muntenkluis.feedback.vaultFull}
      </p>
